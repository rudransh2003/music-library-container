...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/hp/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2056aa2b87f29b45f9f718ABhQUQNMCw0FAQlTBlFTD1UHAFkN', mode: 'build'}); } catch(cjsError) { try { import('file:///home/hp/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2056aa2b87f29b45f9f718ABhQUQNMCw0FAQlTBlFTD1UHAFkN', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
